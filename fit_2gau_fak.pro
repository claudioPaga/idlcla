...
pro fit_2gau_fak, file_counts_fak, emin, emax

  ;;;CP, 18 Sept 2018
  ;;;
  ;;;Summary - Reads in fak spectral file (of E0102), fits two
  ;;;          Gaussians to the brightest emission lines
  

  
  if n_params() lt 3 then begin
     print,"Please enter correct parameters: fit_2gau_fak,filename,en_min, en_max"
     print,"Please enter correct parameters: fit_2gau_fak,'smile_sxi1.fak',0.5, 0.75"
     return
  endif
...
outfile_name = string_split[0]+'_fak_fit.txt'
