...
pro fit_2gau_bb_qdp, file_counts_qdp, emin, emax, key_plot = key_plot
  ...
  if n_params() lt 3 then begin
     print,"Please enter correct parameters: fit_2gau_1lin_bb,filename,en_min, en_max"
     print,"Please enter correct parameters: fit_2gau_1lin_bb,'smile_sxi_casa_10ks_999.qdp',0.8, 1.6"
     return
  endif
...
if keyword_set(key_plot) then begin
   entry_device = !d.name
   plotfilenameps = string_split[0]+'_qdp_fit_2gau_bb.ps'
   set_plot,'ps'
